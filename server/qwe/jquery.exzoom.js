...
;(function ($, window) {
    ...
    $.fn.extend({
        "exzoom": function exzoom(method, options) {
            if (arguments.length === 0 || (typeof method === "undefined" ? "undefined" : _typeof(method)) === 'object' && !options) {
                if (this.length === 0) {
    ...
    function move(direction) {
        ...
        //切换大图
        var new_position = -boxWidth * imgIndex;
    ...
    function copute_image_prop(image, width, height) {
        ...
        if (img_scale === 1) {
            ...
            exzoom_nav_inner.append("<span><img src=\"" + src + "\" height=\"" + g.navHeight + "\" style=\"left:" + _top + "px;\"/></span>");
        }
